...
import { fetchAllData, getStoredBCVLunes, setStoredBCVLunes, getReminderEnabled, setReminderEnabled } from '../services/api';
...
export default function RatesScreen() {
  ...
  const brecha =
    data.tasaBCV && data.tasaParalelo
      ? ((data.tasaParalelo - data.tasaBCV) / data.tasaBCV) * 100
      : null;

  const brechaLunes =
    tasaBCVLunes && data.tasaParalelo
